...
<center>
    <form action="/holo/livingboard/reportArticlePro.holo" method="post">
    	<table border="1" width="500" style="border-collapse:collapse">
    		...
    		<tr>
    			...
    			<td> <textarea name="reason" rows="20" cols="60" placeholder="신고사유을 입력하세요" style="resize:none;"></textarea>
    		</td>
    		<tr>
