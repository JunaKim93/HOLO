...
<body>
   <div class="board_wrap">
      ...
      <form method="post" id="writeform" name="writeform" action="/holo/market/updatePro.holo?articlenum=${article.articlenum}&pageNum=${pageNum}" onsubmit="return writeSave()">
      <div class="board_write_wrap">
         <div class="board_write">
            <div class="title">
               <dl>
                  <dt>제목</dt>
                  <dd><input type="text" name="subject" placeholder="제목 (상품명)" value="${article.subject}"></dd>
               </dl>
            </div>
            <div class="title">
						<dl>
						<dt>가격</dt>
                  <dd><input type="text" name="price" placeholder="희망 판매(구매) 가격/ 무료 나눔은 값을 입력하셔도 반영되지 않습니다." value="${article.price }"> 원</dd>
						</dl>
					</div>
            <div class="title">
						<dl>
		<dt>상품 상태</dt>
			<dd><input type="radio" name="condition" value="unopened" 
			...
			<input type="radio" name="condition" value="used" 
				<c:if test="${article.condition eq 'used'}">checked</c:if>/>사용감 있음</dd>
			</dl>
			</div>
  <div class="title">
  <dl>
		<dt>배송 방법</dt>
			<dd><input type="radio" name="dealing" value="direct" 
			...
			<input type="radio" name="dealing" value="online" 
				<c:if test="${article.dealing eq 'online'}">checked</c:if>/>온라인 전송(기프티콘 등)</dd>
         ...
         <div class="button_wrap">
				...
				<input type="submit" id="writebtn" class="writebtn" value="수정">
