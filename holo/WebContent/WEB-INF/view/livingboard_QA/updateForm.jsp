...
<form method="post" name="updateForm" action="/holo/livingboard_QA/updatePro.holo" onSubmit="return checkValue()">
<table align="center" border="1" style="border-collapse:collapse">
	...
	<tr>
		<td colspan="2" align="right">
			...
			<select name="category_b">
				...
				<option value="question" selected>질문게시판</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
			...
			<input type="button" value="목록으로" Onclick="window.location='/holo/livingboard_QA/list.holo'" />
		</td>
	</tr>
