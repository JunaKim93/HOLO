...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<script>
		function del_confirm(){
			if(confirm("삭제하시겠습니까?")){
				window.location="/holo/message/delMsgS.holo?msgnum="+${msg.msgnum}+"&status="+${msg.status};
			}
		}
	</script>
	...
	<table border="1" align="center" width="400">
		...
		<tr>
			<td colspan="3" align="right">
				<input type="button" value="뒤로가기"	onclick="window.location='/holo/message/msgListS.holo'" />
			</td>
		</tr>		
	</table>
	<div align="center">
