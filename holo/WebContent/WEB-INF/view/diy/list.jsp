	...
	<c:if test="${count >0}">
				...
				<div class="top">
					...
					<div class="count">조회수</div>
						...
						<div>
							...
							<div class="title">
								<a href="/holo/diy/content.holo?articlenum=${list.articlenum}&pageNum=${currentPage}">
		...
		<div align="center">
			<form action="/holo/diy/list.holo">
				...
				</select> <input type="text" name="search"> <input type="submit" style="width:35px;height:22px;background-color: #1e57a4; color:#fff;border:none;"
					value="검색"> &nbsp;
