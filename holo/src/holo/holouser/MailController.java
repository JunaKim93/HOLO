	...
	public String mailSend(HolouserDTO dto, Model model) {
		try {
			...
			MimeMessage message = mailSender.createMimeMessage();
	         ...
	         messageHelper.setText(new StringBuffer().append("<h1>[HOLO에 오신것을 환영합니다]</h1>")
	                  .append("<p>아래 링크를 클릭하면 인증이 완료됩니다.</p>")
